      ...
      <Tabs defaultValue="visual" className="w-full">
        ...
        <TabsContent value="library">
          <TemplateLibraryPanel 
            currentTemplate={{ blocks, design, pageSetup }} 
            onLoadTemplate={(loadedTemplate) => {
              setBlocks(loadedTemplate.blocks);
              setDesign(loadedTemplate.design);
              setPageSetup(loadedTemplate.pageSetup);
              undoRedo.push(loadedTemplate);
              onChange(loadedTemplate);
            }}
          />
        </TabsContent>
