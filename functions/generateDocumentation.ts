...
async function generateDocumentGenerationDoc(base44) {
    let doc = '# AUTOMATISCHE DOKUMENTEN-GENERIERUNG - VOLLSTÄNDIGE SYSTEM-DOKUMENTATION\n\n';
    doc += '**Metadaten:**\n';
    doc += `- Generiert am: ${new Date().toLocaleString('de-DE')}\n`;
    doc += '- Verwendungszweck: KI-Assistent Kontextinformation + technische Referenz\n';
    doc += '- Anzahl dokumentierter Dokument-Typen: 7\n';
    doc += '- Anzahl Template-Variablen: ~80\n';
    doc += '- Tech-Stack: React, Puppeteer, Base44 Core\n\n';
    doc += '---\n\n';
    
    doc += '## INHALTSVERZEICHNIS\n\n';
    doc += '1. System-Übersicht & Architektur\n';
    doc += '2. Template-System (Vorlagen)\n';
    doc += '3. Dokumenttypen & Use-Cases\n';
    doc += '4. Datenquellen & Entity-Mapping\n';
    doc += '5. Template-Variablen (Vollständige Referenz)\n';
    doc += '6. Generierungs-Prozess (Schritt-für-Schritt)\n';
    doc += '7. PDF-Konvertierung\n';
    doc += '8. Post-Generierung & Versand\n';
    doc += '9. Spezial-Dokumente (Betriebskosten, Anlage V, etc.)\n';
    doc += '10. Fehlerbehandlung & Edge Cases\n\n';
    
    doc += '---\n\n';
    
    doc += '# 1. SYSTEM-ÜBERSICHT & ARCHITEKTUR\n\n';
    
    doc += '## 1.1 KOMPONENTEN-ÜBERSICHT\n\n';
    doc += '```\n';
    doc += '┌─────────────────────────────────────────────────────────────┐\n';
    doc += '│                    DOKUMENT-GENERATOR                       │\n';
    doc += '└─────────────────────────────────────────────────────────────┘\n';
    doc += '         │                    │                    │\n';
    doc += '         ▼                    ▼                    ▼\n';
    doc += '   ┌──────────┐        ┌──────────┐        ┌──────────┐\n';
    doc += '   │ TEMPLATE │        │ DATEN    │        │   PDF    │\n';
    doc += '   │  ENGINE  │◄───────┤  LOADER  │────────►│ GENERATOR│\n';
    doc += '   └──────────┘        └──────────┘        └──────────┘\n';
    doc += '         │                    │                    │\n';
    doc += '         ▼                    ▼                    ▼\n';
    doc += '   Template DB         Entity Data          Puppeteer\n';
    doc += '   TextBlocks          (Building, etc.)     HTML→PDF\n';
    doc += '         │                                        │\n';
    doc += '         └────────────────────┬───────────────────┘\n';
    doc += '                              ▼\n';
    doc += '                      Document Entity\n';
    doc += '                      (gespeichert)\n';
    doc += '                              │\n';
    doc += '                              ├──► LetterXpress (Post)\n';
    doc += '                              ├──► E-Mail\n';
    doc += '                              └──► Download\n';
    doc += '```\n\n';
    
    doc += '## 1.2 KERN-ENTITIES\n\n';
    doc += '| Entity | Zweck | Speichert |\n';
    doc += '|--------|-------|----------|\n';
    doc += '| **Template** | Vorlagen-Definition | HTML, Platzhalter, Styles |\n';
    doc += '| **Document** | Generierte Dokumente | Finales HTML, PDF-URL, Status |\n';
    doc += '| **TextBlock** | Wiederverwendbare Textbausteine | Vordefinierte Textpassagen |\n';
    doc += '| **LetterShipment** | Post-Versand-Tracking | LXP Job-ID, Tracking-Code |\n\n';
    
    doc += '## 1.3 GENERIERUNGS-WORKFLOW (HIGH-LEVEL)\n\n';
    doc += '```\n';
    doc += '┌──────────┐\n';
    doc += '│  START   │ User klickt "Dokument erstellen"\n';
    doc += '└─────┬────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 1. TEMPLATE WÄHLEN  │ DocumentCreateWizard.jsx\n';
    doc += '│   - Kategorie       │\n';
    doc += '│   - Vorlage         │\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 2. DATEN AUSWÄHLEN  │ Welches Gebäude? Welcher Mieter?\n';
    doc += '│   - Building        │\n';
    doc += '│   - Tenant          │\n';
    doc += '│   - Contract        │\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 3. TEXTBAUSTEINE    │ Optional: Vordefinierte Textpassagen\n';
    doc += '│   - Kündigungsfrist │\n';
    doc += '│   - Hinweise        │\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 4. VORSCHAU         │ Finales Dokument prüfen\n';
    doc += '│   - HTML anzeigen   │\n';
    doc += '│   - Editierbar      │\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 5. GENERIEREN       │\n';
    doc += '│   - Platzhalter     │ {{building.name}} → "Musterstr. 10"\n';
    doc += '│     ersetzen        │\n';
    doc += '│   - HTML finalisiert│\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 6. PDF ERSTELLEN    │ functions/generatePDF.js\n';
    doc += '│   - Puppeteer       │ HTML → PDF\n';
    doc += '│   - Upload Storage  │\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 7. SPEICHERN        │ Document Entity CREATE\n';
    doc += '│   - content_html    │\n';
    doc += '│   - pdf_url         │\n';
    doc += '│   - status="erstellt"│\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌─────────────────────┐\n';
    doc += '│ 8. OPTIONAL: VERSAND│\n';
    doc += '│   - LetterXpress    │ SendLetterDialog.jsx\n';
    doc += '│   - E-Mail          │\n';
    doc += '│   - Download        │\n';
    doc += '└─────┬───────────────┘\n';
    doc += '      ▼\n';
    doc += '┌──────────┐\n';
    doc += '│   ENDE   │ Dokument fertig\n';
    doc += '└──────────┘\n';
    doc += '```\n\n';
...
async function generateUserWorkflowsDoc(base44) {
    ...
    doc += '### 3.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Eigentümerwechsel / Verkauf dokumentieren\n\n';
    doc += '- **Hauptziel**: Eigentumsübergang rechtssicher im System abbilden mit Versionierung\n\n';
    doc += '- **User-Typ**: Admin, Verwalter\n\n';
    doc += '- **Häufigkeit**: Selten (bei Verkauf, alle 5-15 Jahre)\n\n';
    doc += '- **Komplexität**: Mittel-Komplex (rechtliche Implikationen)\n\n';
    doc += '- **Geschätzte Dauer**: 10-15 Minuten\n\n';
    
    doc += '### 3.2 Voraussetzungen\n\n';
    doc += '- ✅ Building existiert\n\n';
    doc += '- ✅ Aktueller Eigentümer ist zugeordnet (OwnerRelationship aktiv)\n\n';
    doc += '- ✅ Neuer Eigentümer ist im System (oder wird parallel angelegt)\n\n';
    doc += '- ✅ Verkaufsdatum bekannt (notariell beurkundet)\n\n';
    doc += '- ⚠️ Steuerberater sollte informiert werden (steuerliche Konsequenzen!)\n\n';
    
    doc += '### 3.3 Schritt-für-Schritt\n\n';
    doc += '**SCHRITT 1: Navigation**\n\n';
    doc += '- **Seite**: `BuildingDetail` → Tab "Eigentümer"\n\n';
    doc += '- **User sieht**: Liste aktueller Eigentümer mit Anteilen\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ AKTUELLE EIGENTÜMER:                              │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ • Max Mustermann (Privatperson)       50%         │\n';
    doc += '  │   Seit: 01.01.2010                                │\n';
    doc += '  │   [Bearbeiten] [Verkauf dokumentieren]            │\n';
    doc += '  │                                                   │\n';
    doc += '  │ • Erika Musterfrau (Privatperson)     50%         │\n';
    doc += '  │   Seit: 01.01.2010                                │\n';
    doc += '  │   [Bearbeiten] [Verkauf dokumentieren]            │\n';
    ...
    doc += '**SCHRITT 2: Verkauf einleiten**\n\n';
    doc += '- **User-Aktion**: Button "Verkauf dokumentieren" bei bisherigem Eigentümer\n\n';
    doc += '- **Dialog**: Eigentümerwechsel-Dialog öffnet sich\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Eigentümerwechsel durchführen                     │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ VERKÄUFER:                                        │\n';
    doc += '  │ Max Mustermann (50% Anteil)                       │\n';
    doc += '  │ Seit: 01.01.2010                                  │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Verkaufsdatum 📅                        │\n';
    doc += '  │   → "15.07.2024" (Notartermin)                   │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Neuer Eigentümer ▼                      │\n';
    doc += '  │   ⚪ Existierenden wählen                         │\n';
    doc += '  │   ⚪ Neuen anlegen                                │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Anteil ändern?                         │\n';
    doc += '  │   → 50% (Standard: übernimmt gleichen Anteil)    │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Verkaufspreis (vertraulich)            │\n';
    doc += '  │   → "225.000 €" (für 50% Anteil)                 │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ ⚠️ Wichtig: Steuerberater informieren!            │\n';
    doc += '  │    - Spekulationssteuer bei Verkauf < 10 Jahre    │\n';
    doc += '  │    - AfA muss neu berechnet werden (neuer Eigent.)│\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Wechsel durchführen]                │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 3: Neuen Eigentümer wählen oder anlegen**\n\n';
    doc += '- **Variante A**: Existierenden Eigentümer wählen\n\n';
    doc += '  - Dropdown mit Suche\n\n';
    doc += '  - Angezeigt: Name, Typ (Privatperson/GbR/GmbH)\n\n';
    doc += '  - Auswählen → weiter zu Schritt 4\n\n';
    doc += '- **Variante B**: Neuen Eigentümer anlegen\n\n';
    doc += '  - Sub-Dialog öffnet sich (siehe Workflow 2)\n\n';
    doc += '  - Nach Anlage: Automatisch in Dropdown ausgewählt\n\n';
    doc += '  - Weiter zu Schritt 4\n\n';
    
    doc += '**SCHRITT 4: Validierung & Speichern**\n\n';
    doc += '- **Validierungen**:\n\n';
    doc += '  - ✅ BLOCKER: Verkaufsdatum muss in Vergangenheit oder heute liegen\n\n';
    doc += '  - ✅ BLOCKER: Verkaufsdatum muss nach valid_from des alten Eigentümers liegen\n\n';
    doc += '  - ✅ BLOCKER: Summe aller Eigentümer-Anteile muss weiterhin 100% sein\n\n';
    doc += '  - ⚠️ WARNING: "Keine Lücke zwischen Eigentümern!" (alt.valid_until = neu.valid_from)\n\n';
    doc += '  - ⚠️ WARNING: "AfA muss für neuen Eigentümer neu berechnet werden"\n\n';
    doc += '- **User-Aktion**: Button "Wechsel durchführen"\n\n';
    doc += '- **Hintergrund (Transaktional)**:\n\n';
    doc += '  ```javascript\n';
    doc += '  // 1. Alte OwnerRelationship beenden\n';
    doc += '  await OwnerRelationship.update(oldRelationshipId, {\n';
    doc += '    valid_until: "2024-07-15"  // Verkaufsdatum\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  // 2. Neue OwnerRelationship erstellen\n';
    doc += '  await OwnerRelationship.create({\n';
    doc += '    building_id: building.id,\n';
    doc += '    owner_id: newOwner.id,\n';
    doc += '    share_percentage: 50,  // gleicher Anteil\n';
    doc += '    valid_from: "2024-07-16",  // Tag nach Verkauf\n';
    doc += '    valid_until: null,  // aktuell gültig\n';
    doc += '    purchase_price_share: 225000  // optional\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  // 3. ActivityLog\n';
    doc += '  await ActivityLog.create({\n';
    doc += '    action: "owner_relationship_changed",\n';
    doc += '    entity_type: "Building",\n';
    doc += '    entity_id: building.id,\n';
    doc += '    details: {\n';
    doc += '      old_owner: oldOwner.name,\n';
    doc += '      new_owner: newOwner.name,\n';
    doc += '      sale_date: "2024-07-15",\n';
    doc += '      share: 50\n';
    doc += '    }\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  // 4. Notification für Admin\n';
    doc += '  await Notification.create({\n';
    doc += '    type: "warning",\n';
    doc += '    title: "Eigentümerwechsel",\n';
    doc += '    message: `Objekt ${building.name}: ${oldOwner.name} → ${newOwner.name}. Steuerberater kontaktieren!`\n';
    doc += '  });\n';
    doc += '  ```\n\n';
    doc += '- **Dauer**: ~1 Sekunde\n\n';
    doc += '- **Erfolg**: Toast "✅ Eigentümerwechsel dokumentiert - Steuerberater informieren!"\n\n';
    
    doc += '### 3.4 Nach-Prozess (manuell erforderlich)\n\n';
    doc += '**Was User NICHT vergessen darf**:\n\n';
    doc += '1. **Steuerberater kontaktieren**:\n\n';
    doc += '   - Spekulationssteuer prüfen (Verkauf < 10 Jahre nach Kauf?)\n\n';
    doc += '   - AfA für neuen Eigentümer neu berechnen (ab Kaufdatum)\n\n';
    doc += '   - Veräußerungsgewinn ermitteln\n\n';
    doc += '2. **Anlage V für Verkaufsjahr**:\n\n';
    doc += '   - Alter Eigentümer: Anteilig bis Verkaufsdatum\n\n';
    doc += '   - Neuer Eigentümer: Anteilig ab Verkaufsdatum\n\n';
    doc += '3. **Mietverträge ggf. neu beurkunden**:\n\n';
    doc += '   - Bei GmbH-Verkauf oft erforderlich\n\n';
    doc += '   - Mieter über neuen Vermieter informieren\n\n';
    
    doc += '### 3.5 Ausgabe/Ergebnis\n\n';
    doc += '**Neue Datensätze**:\n\n';
    doc += '- 1x OwnerRelationship UPDATE (alte: valid_until gesetzt)\n\n';
    doc += '- 1x OwnerRelationship CREATE (neue: valid_from = Verkaufsdatum + 1 Tag)\n\n';
    doc += '- 1x ActivityLog ("owner_relationship_changed")\n\n';
    doc += '- 1x Notification (an Admins)\n\n';
    
    doc += '### 3.6 Fehlerszenarien\n\n';
    doc += '**Fehler 1: Zeitliche Lücke**\n\n';
    doc += '- **Szenario**: User setzt Verkaufsdatum 15.07., neues valid_from aber 20.07.\n\n';
    doc += '- **Reaktion**: ⚠️ WARNING "Lücke von 5 Tagen - Eigentumsverhältnisse unklar"\n\n';
    doc += '- **System-Vorschlag**: "Neues valid_from automatisch auf 16.07. setzen?"\n\n';
    
    doc += '**Fehler 2: Eigentümer-Anteile ergeben nicht 100%**\n\n';
    doc += '- **Szenario**: Max verkauft 50%, aber es gibt noch Erika mit 50% → OK\n\n';
    doc += '- **Szenario**: Max verkauft 60% (hatte aber nur 50%) → ❌ BLOCKER\n\n';
    doc += '- **Reaktion**: "Anteil ungültig - Max besitzt nur 50%"\n\n';
    
    doc += '### 3.7 Beispiel-Durchlauf\n\n';
    doc += '```\n';
    doc += 'AUSGANGSLAGE:\n';
    doc += '──────────────────────────────────────────────\n';
    doc += 'Objekt: Hauptstraße 1, Berlin\n';
    doc += 'Eigentümer: Max Mustermann (50%) + Erika Musterfrau (50%)\n';
    doc += 'Seit: 01.01.2010\n';
    doc += 'Kaufpreis damals: 300.000€ (je 150.000€)\n';
    doc += '\n';
    doc += 'VERKAUF:\n';
    doc += '──────────────────────────────────────────────\n';
    doc += 'Verkäufer: Max Mustermann (50%)\n';
    doc += 'Käufer: Klaus Fischer (Privatperson, neu)\n';
    doc += 'Verkaufsdatum: 15.07.2024 (Notar-Termin)\n';
    doc += 'Verkaufspreis: 225.000€ (50% von 450.000€)\n';
    doc += '\n';
    doc += 'DURCHFÜHRUNG:\n';
    doc += '──────────────────────────────────────────────\n';
    doc += '1. Tab "Eigentümer" → "Verkauf dokumentieren" bei Max\n';
    doc += '2. Verkaufsdatum: 15.07.2024\n';
    doc += '3. Neuer Eigentümer: Klaus Fischer (neu anlegen)\n';
    doc += '   - Vorname: Klaus\n';
    doc += '   - Nachname: Fischer\n';
    doc += '   - Adresse: Fischerweg 5, 12345 Fischerstadt\n';
    doc += '   - Steuer-ID: 98765432109\n';
    doc += '4. Anteil: 50% (übernommen)\n';
    doc += '5. Verkaufspreis: 225.000€ (optional, vertraulich)\n';
    doc += '6. "Wechsel durchführen" klicken\n';
    doc += '\n';
    doc += 'ERGEBNIS:\n';
    doc += '──────────────────────────────────────────────\n';
    doc += 'Eigentümer ab 16.07.2024:\n';
    doc += '  • Erika Musterfrau (50%) - unverändert\n';
    doc += '  • Klaus Fischer (50%) - neu\n';
    doc += '\n';
    doc += 'Eigentümer bis 15.07.2024:\n';
    doc += '  • Max Mustermann (50%) - archiviert\n';
    doc += '  • Erika Musterfrau (50%)\n';
    doc += '\n';
    doc += 'STEUERLICHE FOLGEN:\n';
    doc += '──────────────────────────────────────────────\n';
    doc += 'Max Mustermann:\n';
    doc += '  - Anlage V 2024: Einnahmen/Kosten 01.01.-15.07.\n';
    doc += '  - Spekulationssteuer: NEIN (> 10 Jahre Haltedauer)\n';
    doc += '  - Veräußerungsgewinn: 225.000€ - 150.000€ = 75.000€ (steuerfrei)\n';
    doc += '\n';
    doc += 'Klaus Fischer:\n';
    doc += '  - Anlage V 2024: Einnahmen/Kosten 16.07.-31.12.\n';
    doc += '  - AfA ab 2024: Kaufpreis 225.000€ (nur 50% vom Gebäude)\n';
    doc += '  - Neue AfA: (225.000€ - Grundstücksanteil) × 2% = ~3.000€/Jahr\n';
    doc += '```\n\n';
    
    doc += '### 3.8 Tipps & Best Practices\n\n';
    doc += '✅ **DO**: Verkaufsdatum = Notartermin (rechtlich verbindlich)\n\n';
    doc += '✅ **DO**: Sofort nach Wechsel Steuerberater informieren\n\n';
    doc += '✅ **DO**: Verkaufspreis dokumentieren (auch wenn vertraulich)\n\n';
    doc += '✅ **DO**: Zeitliche Lücken vermeiden (valid_until = valid_from - 1 Tag)\n\n';
    doc += '❌ **DON\'T**: Eigentümerwechsel rückdatieren (rechtlich problematisch)\n\n';
    doc += '❌ **DON\'T**: Verkaufspreis vergessen (wichtig für Spekulationssteuer-Berechnung)\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 5: Mieter einziehen / ausziehen\n\n';
    
    doc += '### 5.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Mieter Ein-/Auszug mit Übergabeprotokoll\n\n';
    doc += '- **Hauptziel**: Mieterwechsel dokumentieren, Zählerstände erfassen, Kaution abrechnen\n\n';
    doc += '- **User-Typ**: Verwalter\n\n';
    doc += '- **Häufigkeit**: Bei jedem Mieterwechsel (alle 3-10 Jahre pro Wohnung)\n\n';
    doc += '- **Komplexität**: Komplex (viele Schritte, rechtlich wichtig)\n\n';
    doc += '- **Geschätzte Dauer**: Auszug 20 Min + Einzug 15 Min = 35 Min gesamt\n\n';
    
    doc += '### 5.2 TEIL A: MIETER-AUSZUG\n\n';
    
    doc += '**SCHRITT 1: Kündigung dokumentieren**\n\n';
    doc += '- **Voraussetzung**: Kündigung ist eingegangen (Kündigungs-Dokument erstellt)\n\n';
    doc += '- **Seite**: `/Contracts` → Vertrag öffnen\n\n';
    doc += '- **User-Aktion**: Button "Vertrag kündigen"\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Mietvertrag kündigen                              │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Pflicht] Kündigungsdatum 📅                      │\n';
    doc += '  │   → "15.03.2024" (Datum des Kündigungsschreibens)│\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Auto] Kündigungsfrist                            │\n';
    doc += '  │   → 3 Monate (aus Vertrag)                        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Auto] Letzter Miettag                            │\n';
    doc += '  │   → 30.06.2024 (berechnet)                        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Auto] Wohnungsübergabe                           │\n';
    doc += '  │   → 30.06.2024 (Standard = letzter Miettag)      │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Kündigung speichern]                │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    doc += '- **Berechnung Letzter Miettag** (siehe Geschäftslogik-Doku, Regel D1.1)\n\n';
    doc += '- **Hintergrund**:\n\n';
    doc += '  ```javascript\n';
    doc += '  await LeaseContract.update(contractId, {\n';
    doc += '    status: "terminated",\n';
    doc += '    termination_date: "2024-03-15",\n';
    doc += '    end_date: "2024-06-30"  // letzter Miettag\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  // Payment-Generierung stoppen ab end_date\n';
    doc += '  // (is_future_booking Buchungen werden nicht mehr erstellt)\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 2: Übergabeprotokoll erstellen**\n\n';
    doc += '- **Zeitpunkt**: Am Übergabetag (30.06.2024)\n\n';
    doc += '- **User-Aktion**: Dokumente → Template "Übergabeprotokoll" → Erstellen\n\n';
    doc += '- **Wizard-Schritte**:\n\n';
    doc += '  1. Template wählen: "Übergabeprotokoll (Auszug)"\n\n';
    doc += '  2. Datenquellen: Building, Unit, auszugTenant, Contract\n\n';
    doc += '  3. Checkliste durchgehen:\n\n';
    doc += '     ```\n';
    doc += '     RAUM-ZUSTAND:\n';
    doc += '     ☑ Küche: [✅ Gut] [⚪ Mängel] [⚪ Schäden]\n';
    doc += '       → Mängel: "Kühlschrank defekt (Vermieter repariert)"\n';
    doc += '     ☑ Bad: [✅ Gut] [⚪ Mängel] [⚪ Schäden]\n';
    doc += '     ☑ Wohnzimmer: [⚪ Gut] [✅ Mängel] [⚪ Schäden]\n';
    doc += '       → Mängel: "Kratzer im Parkett (Mieter verursacht)"\n';
    doc += '     ☑ Schlafzimmer: [✅ Gut]\n';
    doc += '     ☑ Flur: [✅ Gut]\n';
    doc += '     \n';
    doc += '     ZÄHLERSTÄNDE (Auszug):\n';
    doc += '     • Strom: [12450] kWh (alt: 11200, Verbrauch 1.250 kWh)\n';
    doc += '     • Wasser: [145] m³ (alt: 100, Verbrauch 45 m³)\n';
    doc += '     • Heizung: [4850] kWh\n';
    doc += '     \n';
    doc += '     SCHLÜSSEL-ÜBERGABE:\n';
    doc += '     • Wohnungsschlüssel: 3 Stück ✅\n';
    doc += '     • Briefkastenschlüssel: 1 Stück ✅\n';
    doc += '     • Kellerschlüssel: 1 Stück ✅\n';
    doc += '     ```\n\n';
    doc += '  4. Mängel/Schäden bewerten:\n\n';
    doc += '     - Kratzer im Parkett → Schönheitsreparatur erforderlich\n\n';
    doc += '     - Kosten schätzen: ~250€\n\n';
    doc += '     - Von Kaution einbehalten? [✅ Ja] [⚪ Nein]\n\n';
    doc += '  5. PDF generieren + unterschreiben lassen\n\n';
    doc += '- **Ergebnis**: Document mit Unterschriften (Vermieter + Mieter)\n\n';
    
    doc += '**SCHRITT 3: Zählerstände speichern**\n\n';
    doc += '- **User-Aktion**: Zähler-Modul → Zählerstände aktualisieren\n\n';
    doc += '  ```javascript\n';
    doc += '  await Meter.update(stromZaehlerId, {\n';
    doc += '    current_reading: 12450,\n';
    doc += '    last_reading_date: "2024-06-30",\n';
    doc += '    reading_type: "Auszug"\n';
    doc += '  });\n';
    doc += '  // Für alle Zähler wiederholen\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 4: Kaution abrechnen**\n\n';
    doc += '- **Berechnung**:\n\n';
    doc += '  ```javascript\n';
    doc += '  kaution_hinterlegt = 2400.00  // 3 Monatsmieten\n';
    doc += '  schaeden_abzug = 250.00       // Parkett-Kratzer\n';
    doc += '  offene_forderungen = 0.00     // alle Mieten bezahlt\n';
    doc += '  nk_nachzahlung_2023 = -120.00 // Guthaben\n';
    doc += '  \n';
    doc += '  rueckzahlung = kaution_hinterlegt - schaeden_abzug + nk_nachzahlung_2023\n';
    doc += '               = 2400 - 250 + (-120)\n';
    doc += '               = 2.030,00€\n';
    doc += '  ```\n\n';
    doc += '- **User-Aktion**: Dokument "Kautionsabrechnung" generieren\n\n';
    doc += '- **Überweisung**: 2.030€ an Mieter zurücküberweisen\n\n';
    
    doc += '**SCHRITT 5: Vertrag abschließen**\n\n';
    doc += '- **User-Aktion**: LeaseContract UPDATE\n\n';
    doc += '  ```javascript\n';
    doc += '  await LeaseContract.update(contractId, {\n';
    doc += '    status: "expired",  // Vertrag beendet\n';
    doc += '    actual_end_date: "2024-06-30",\n';
    doc += '    kaution_returned: true,\n';
    doc += '    kaution_returned_amount: 2030,\n';
    doc += '    kaution_returned_date: "2024-07-05"\n';
    doc += '  });\n';
    doc += '  ```\n\n';
    
    doc += '### 5.3 TEIL B: MIETER-EINZUG\n\n';
    
    doc += '**SCHRITT 1: Neuen Mietvertrag erstellen**\n\n';
    doc += '- **Siehe**: Workflow 4 (Mietvertrag erstellen)\n\n';
    doc += '- **Besonderheit**: start_date sollte nach Auszug des Vormieters liegen\n\n';
    doc += '  - Idealerweise: 01.07.2024 (Tag nach Auszug)\n\n';
    doc += '  - Oder später (bei Renovierung dazwischen)\n\n';
    
    doc += '**SCHRITT 2: Übergabeprotokoll (Einzug)**\n\n';
    doc += '- **Template**: "Übergabeprotokoll (Einzug)"\n\n';
    doc += '- **Checkliste**: \n\n';
    doc += '  - Zustand NACH Renovierung/Reinigung\n\n';
    doc += '  - Zählerstände EINZUG (neu)\n\n';
    doc += '  - Schlüssel übergeben (an neuen Mieter)\n\n';
    doc += '- **Zählerstände**:\n\n';
    doc += '  ```javascript\n';
    doc += '  await Meter.update(stromZaehlerId, {\n';
    doc += '    current_reading: 12450,  // gleicher Stand wie bei Auszug (Strom unbewohnt)\n';
    doc += '    last_reading_date: "2024-07-01",\n';
    doc += '    reading_type: "Einzug",\n';
    doc += '    contract_id: newContractId  // verknüpfen mit neuem Vertrag\n';
    doc += '  });\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 3: Kaution einzahlen**\n\n';
    doc += '- **Varianten**:\n\n';
    doc += '  - Sofort (1x 2.400€)\n\n';
    doc += '  - In Raten (3× 800€ über 3 Monate)\n\n';
    doc += '- **Zahlung erfassen**:\n\n';
    doc += '  - Bei Eingang: `LeaseContract.deposit_paid = true`\n\n';
    doc += '  - Bei Raten: Separate Payment-Entities für Kautionsraten\n\n';
    
    doc += '### 5.4 Fehlerszenarien\n\n';
    doc += '**Fehler 1: Neuer Vertrag vor Auszug altem Mieter**\n\n';
    doc += '- **Reaktion**: ❌ BLOCKER "Überschneidung - Wohnung ist bis 30.06.2024 vermietet"\n\n';
    doc += '- **Lösung**: start_date auf 01.07.2024 oder später setzen\n\n';
    
    doc += '**Fehler 2: Zählerstände nicht plausibel**\n\n';
    doc += '- **Szenario**: Einzug-Stand niedriger als Auszug-Stand\n\n';
    doc += '- **Reaktion**: ⚠️ WARNING "Zählerstand rückwärts? Bitte prüfen (Auszug 12450, Einzug 12400)"\n\n';
    
    doc += '### 5.5 Tipps & Best Practices\n\n';
    doc += '✅ **DO**: Übergabeprotokoll MIT Mieter unterschreiben lassen (Beweissicherung)\n\n';
    doc += '✅ **DO**: Fotos machen von Schäden (in Protokoll vermerken, Fotos als Anhang)\n\n';
    doc += '✅ **DO**: Zählerstände SOFORT erfassen (nicht nachträglich)\n\n';
    doc += '✅ **DO**: Kaution auf separates Konto (Treuhandkonto) überweisen\n\n';
    doc += '❌ **DON\'T**: Übergabe ohne Protokoll (rechtlich riskant)\n\n';
    doc += '❌ **DON\'T**: Kaution ohne Abrechnung einbehalten (max. 6 Monate nach Auszug!)\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 9: Anlage V generieren und prüfen\n\n';
    
    doc += '### 9.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Anlage V (Vermietung & Verpachtung) erstellen\n\n';
    doc += '- **Hauptziel**: Steuerformular für Finanzamt vorbereiten\n\n';
    doc += '- **User-Typ**: Verwalter, Steuerberater, Eigentümer\n\n';
    doc += '- **Häufigkeit**: Jährlich (für Steuererklärung)\n\n';
    doc += '- **Komplexität**: Komplex (steuerlich relevant)\n\n';
    doc += '- **Geschätzte Dauer**: 15-30 Minuten\n\n';
    
    doc += '### 9.2 Voraussetzungen\n\n';
    doc += '- ✅ Building vollständig erfasst (Adresse, Kaufdaten)\n\n';
    doc += '- ✅ BuildingTaxLibrary initialisiert\n\n';
    doc += '- ✅ Mietverträge im Steuerjahr aktiv\n\n';
    doc += '- ✅ Alle Rechnungen erfasst und kategorisiert\n\n';
    doc += '- ✅ AfA-Plan generiert (aus Kaufvertrag)\n\n';
    doc += '- ✅ Finanzierungen erfasst (für Schuldzinsen)\n\n';
    
    doc += '### 9.3 Schritt-für-Schritt\n\n';
    doc += '**SCHRITT 1: Anlage V initialisieren**\n\n';
    doc += '- **Seite**: `/TaxForms`\n\n';
    doc += '- **User-Aktion**: Button "Neue Anlage V" (oben rechts, grün)\n\n';
    doc += '- **Dialog**: Wizard öffnet sich (4 Schritte)\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Anlage V erstellen (1/4)                          │\n';
    doc += '  │ [━━━━━━━━░░░░░░░░░░░░░░░░░░░░] 25%               │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Pflicht] Gebäude ▼                               │\n';
    doc += '  │   → "Hauptstraße 1, Berlin"                       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Steuerjahr ▼                            │\n';
    doc += '  │   → "2024"                                        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Auto] Eigentümer                                 │\n';
    doc += '  │   → Max Mustermann (50%)                          │\n';
    doc += '  │   → Erika Musterfrau (50%)                        │\n';
    doc += '  │   ℹ️ Bei GbR: Je eigene Anlage V erforderlich     │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Weiter: Einnahmen berechnen →]      │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    doc += '- **Validierungen**:\n\n';
    doc += '  - ✅ BLOCKER: Building.address vollständig\n\n';
    doc += '  - ✅ BLOCKER: BuildingTaxLibrary vorhanden\n\n';
    doc += '  - ⚠️ WARNING: "Keine Mietverträge im Jahr 2024 - Liebhaberei-Prüfung"\n\n';
    
    doc += '**SCHRITT 2: Einnahmen berechnen (automatisch)**\n\n';
    doc += '- **Backend-Funktion**: `calculateAnlageVEinnahmen`\n\n';
    doc += '- **UI**: Loading "Einnahmen werden berechnet..." (~2 Sekunden)\n\n';
    doc += '- **Berechnung**:\n\n';
    doc += '  ```javascript\n';
    doc += '  // ZEILE 9: Einnahmen aus Vermietung\n';
    doc += '  const contracts = await LeaseContract.filter({\n';
    doc += '    building_id: building.id,\n';
    doc += '    // Überschneidung mit Steuerjahr 2024\n';
    doc += '    start_date: { $lte: "2024-12-31" },\n';
    doc += '    $or: [\n';
    doc += '      { end_date: { $gte: "2024-01-01" } },\n';
    doc += '      { end_date: null }\n';
    doc += '    ]\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  let zeile_9 = 0;\n';
    doc += '  for (const contract of contracts) {\n';
    doc += '    const months = calculateMonthsInYear(contract, 2024);\n';
    doc += '    zeile_9 += contract.total_rent * months;\n';
    doc += '  }\n';
    doc += '  // Beispiel: 6 Verträge × 1.030€ × 12 Monate = 74.160€\n';
    doc += '  \n';
    doc += '  // ZEILE 10: Umlagen (Nachzahlungen aus Vorjahr)\n';
    doc += '  const nkStatements = await OperatingCostStatement.filter({\n';
    doc += '    building_id: building.id,\n';
    doc += '    year: 2023  // Vorjahr\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  let zeile_10 = 0;\n';
    doc += '  for (const statement of nkStatements) {\n';
    doc += '    const items = await OperatingCostStatementItem.filter({ statement_id: statement.id });\n';
    doc += '    for (const item of items) {\n';
    doc += '      if (item.balance > 0) {  // nur Nachzahlungen, nicht Guthaben\n';
    doc += '        zeile_10 += item.balance;\n';
    doc += '      }\n';
    doc += '    }\n';
    doc += '  }\n';
    doc += '  // Beispiel: 3 Mieter mit Nachzahlungen = 450€\n';
    doc += '  \n';
    doc += '  // GESAMT-EINNAHMEN\n';
    doc += '  einnahmen_gesamt = zeile_9 + zeile_10;\n';
    doc += '  // = 74.160€ + 450€ = 74.610€\n';
    doc += '  ```\n\n';
    doc += '- **Anzeige**: Übersicht Einnahmen mit Plausibilitäts-Check\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Einnahmen berechnet (2/4)                         │\n';
    doc += '  │ [━━━━━━━━━━━━━━━━░░░░░░░░░░░░] 50%               │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ ZEILE 9: Mieteinnahmen                            │\n';
    doc += '  │   6 Verträge × durchschnittlich 1.030€ × 12 Mon.  │\n';
    doc += '  │   = 74.160,00 €                                   │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ZEILE 10: Umlagen (Nachzahlungen Vorjahr)         │\n';
    doc += '  │   3 Nachzahlungen aus NK-Abrechnung 2023          │\n';
    doc += '  │   = 450,00 €                                      │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ═══════════════════════════════════════════════   │\n';
    doc += '  │ GESAMT-EINNAHMEN: 74.610,00 €                     │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ✅ Plausibilität: OK (ca. 12.435€ pro Wohnung)    │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [← Zurück]  [Weiter: Werbungskosten →]            │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 3: Werbungskosten berechnen (automatisch)**\n\n';
    doc += '- **Backend-Funktion**: `calculateAnlageVWerbungskosten`\n\n';
    doc += '- **UI**: Loading "Werbungskosten werden berechnet..." (~3 Sekunden)\n\n';
    doc += '- **Berechnung** (siehe Geschäftslogik-Doku für vollständige Formeln):\n\n';
    doc += '  ```javascript\n';
    doc += '  // ZEILE 16: AfA (Abschreibung)\n';
    doc += '  const afa = await AfASchedule.filter({\n';
    doc += '    building_id: building.id,\n';
    doc += '    year: 2024\n';
    doc += '  });\n';
    doc += '  zeile_16 = afa[0]?.afa_amount || 0;\n';
    doc += '  // Beispiel: 6.000€\n';
    doc += '  \n';
    doc += '  // ZEILE 33: Grundsteuer\n';
    doc += '  const grundsteuer = sum(GeneratedFinancialBooking WHERE \n';
    doc += '    source_type="Grundsteuer" AND year=2024);\n';
    doc += '  zeile_33 = grundsteuer;\n';
    doc += '  // Beispiel: 1.200€\n';
    doc += '  \n';
    doc += '  // ZEILE 34: Versicherungen (nur nicht-umgelegte)\n';
    doc += '  const versicherungen = await Insurance.filter({\n';
    doc += '    building_id: building.id\n';
    doc += '  });\n';
    doc += '  zeile_34 = sum(v.premium_amount WHERE NOT allocatable);\n';
    doc += '  // Beispiel: 0€ (alle umgelegt) oder 250€ (Mietausfallversicherung)\n';
    doc += '  \n';
    doc += '  // ZEILE 36: Erhaltungsaufwendungen\n';
    doc += '  const erhaltung = await Invoice.filter({\n';
    doc += '    building_id: building.id,\n';
    doc += '    invoice_date: { $gte: "2024-01-01", $lte: "2024-12-31" },\n';
    doc += '    cost_category.category_type: "ERHALTUNG",\n';
    doc += '    cost_category.tax_treatment: "SOFORT"\n';
    doc += '  });\n';
    doc += '  zeile_36 = sum(erhaltung.total_amount);\n';
    doc += '  // Beispiel: 4.500€\n';
    doc += '  \n';
    doc += '  // ZEILE 37: Schuldzinsen (NUR Zinsen, nicht Tilgung!)\n';
    doc += '  const financing = await Financing.filter({\n';
    doc += '    building_id: building.id\n';
    doc += '  });\n';
    doc += '  zeile_37 = sum(f.monthly_rate * 12) - sum(f.tilgung_pro_jahr);\n';
    doc += '  // Beispiel: 14.400€ Raten - 2.400€ Tilgung = 12.000€ Zinsen\n';
    doc += '  \n';
    doc += '  // ZEILE 39: Verwaltungskosten\n';
    doc += '  const verwaltung = await Invoice.filter({\n';
    doc += '    cost_category.name: "Hausverwaltung"\n';
    doc += '  });\n';
    doc += '  zeile_39 = sum(verwaltung.total_amount);\n';
    doc += '  // Beispiel: 480€ (20€ pro Wohnung pro Monat)\n';
    doc += '  \n';
    doc += '  // ZEILEN 38-48: Diverse weitere Kosten\n';
    doc += '  // (Rechtsberatung, Fahrtkosten, Porto, etc.)\n';
    doc += '  \n';
    doc += '  // ZEILE 49: Summe Werbungskosten\n';
    doc += '  zeile_49 = zeile_16 + zeile_33 + zeile_34 + zeile_36 + zeile_37 + zeile_39 + ...;\n';
    doc += '  // Beispiel: 6.000 + 1.200 + 0 + 4.500 + 12.000 + 480 + 1.500 = 25.680€\n';
    doc += '  \n';
    doc += '  // ZEILE 50: Überschuss/Verlust\n';
    doc += '  zeile_50 = einnahmen_gesamt - zeile_49;\n';
    doc += '  // = 74.610€ - 25.680€ = 48.930€ (ÜBERSCHUSS = Gewinn)\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 4: Validierung & Plausibilitäts-Checks**\n\n';
    doc += '- **Backend-Funktion**: `validateAnlageV`\n\n';
    doc += '- **UI**: Validierungs-Ergebnisse anzeigen\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Validierung & Prüfung (3/4)                       │\n';
    doc += '  │ [━━━━━━━━━━━━━━━━━━━━━━░░░░░░] 75%               │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ PRÜFUNGEN:                                        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ✅ Gebäude-Adresse vollständig                    │\n';
    doc += '  │ ✅ Einnahmen plausibel (74.610€)                  │\n';
    doc += '  │ ✅ AfA vorhanden (6.000€)                         │\n';
    doc += '  │ ⚠️ 15%-Regel: 18,5% - Überschritten!              │\n';
    doc += '  │    → Erhaltung 3 Jahre: 15.500€                   │\n';
    doc += '  │    → Grenzwert (15% von 84.000€): 12.600€         │\n';
    doc += '  │    → Überschreitung: 2.900€                       │\n';
    doc += '  │    ACTION: 2.900€ von ERHALTUNG zu HERSTELLUNG    │\n';
    doc += '  │             umbuchen (dann AfA statt sofort)      │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ℹ️ Überschuss: 48.930€ (positiv = Gewinn)         │\n';
    doc += '  │    → Zu versteuern bei ~30% Grenzsteuersatz:      │\n';
    doc += '  │       ca. 14.679€ Steuerlast                      │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ✅ READY für Export                               │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [← Zurück]  [Weiter: Zusammenfassung →]           │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 5: Zusammenfassung & Export**\n\n';
    doc += '- **UI**: Vollständige Anlage V Zeile für Zeile\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Anlage V 2024 - Zusammenfassung (4/4)             │\n';
    doc += '  │ [━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━] 100%         │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ EINNAHMEN:                                        │\n';
    doc += '  │ Zeile 9:  Mieteinnahmen            74.160,00 €    │\n';
    doc += '  │ Zeile 10: Umlagen (Vorjahr)           450,00 €    │\n';
    doc += '  │ ─────────────────────────────────────────────     │\n';
    doc += '  │ SUMME EINNAHMEN:                   74.610,00 €    │\n';
    doc += '  │                                                   │\n';
    doc += '  │ WERBUNGSKOSTEN:                                   │\n';
    doc += '  │ Zeile 16: AfA Gebäude               6.000,00 €    │\n';
    doc += '  │ Zeile 33: Grundsteuer               1.200,00 €    │\n';
    doc += '  │ Zeile 34: Versicherungen                0,00 €    │\n';
    doc += '  │ Zeile 36: Erhaltungsaufwendungen    4.500,00 €    │\n';
    doc += '  │ Zeile 37: Schuldzinsen             12.000,00 €    │\n';
    doc += '  │ Zeile 39: Verwaltung                  480,00 €    │\n';
    doc += '  │ Zeile 40-48: Sonstige               1.500,00 €    │\n';
    doc += '  │ ─────────────────────────────────────────────     │\n';
    doc += '  │ Zeile 49: SUMME WERBUNGSKOSTEN     25.680,00 €    │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ═════════════════════════════════════════════     │\n';
    doc += '  │ Zeile 50: ÜBERSCHUSS               48.930,00 €    │\n';
    doc += '  │ ═════════════════════════════════════════════     │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [PDF exportieren] [Als JSON speichern] [Schließen]│\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 6: Export**\n\n';
    doc += '- **User-Aktion**: Button "PDF exportieren"\n\n';
    doc += '- **Backend**: `exportAnlageVPDF`\n\n';
    doc += '- **Ergebnis**: PDF mit offiziellem Anlage V Layout (4-5 Seiten)\n\n';
    doc += '- **Verwendung**: \n\n';
    doc += '  - Download für Steuerberater\n\n';
    doc += '  - Hochladen in ELSTER (manuell oder später automatisch)\n\n';
    doc += '  - Archivierung im Dokumente-Modul\n\n';
    
    doc += '### 9.4 Ausgabe/Ergebnis\n\n';
    doc += '**Neue Datensätze**:\n\n';
    doc += '- 1x AnlageVSubmission (mit allen Zeilen-Werten)\n\n';
    doc += '- 1x Document (PDF der Anlage V)\n\n';
    doc += '- 1x ActivityLog ("anlage_v_generated")\n\n';
    
    doc += '### 9.5 Häufige Fehler\n\n';
    doc += '1. **15%-Regel übersehen**: User setzt alle Kosten als "sofort absetzbar", überschreitet aber 15%-Grenze\n\n';
    doc += '2. **Tilgung als Werbungskosten**: User denkt Kredit-Tilgung ist absetzbar (nur Zinsen!)\n\n';
    doc += '3. **Umgelegte Kosten absetzen**: User setzt Müllabfuhr als Werbungskosten (wurde aber umgelegt → nicht absetzbar)\n\n';
    doc += '4. **Mehrere Eigentümer vergessen**: Bei GbR müssen ALLE Gesellschafter je eine Anlage V machen\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 11: Dokument mit Template erstellen\n\n';
    
    doc += '### 11.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Template-basierte Dokumentenerstellung\n\n';
    doc += '- **Hauptziel**: Beliebiges Dokument aus Vorlage generieren (Briefe, Verträge, Protokolle)\n\n';
    doc += '- **User-Typ**: Verwalter\n\n';
    doc += '- **Häufigkeit**: Mehrmals pro Woche\n\n';
    doc += '- **Komplexität**: Einfach-Mittel (~5-10 Minuten)\n\n';
    doc += '- **Geschätzte Dauer**: 8 Minuten\n\n';
    
    doc += '### 11.2 Voraussetzungen\n\n';
    doc += '- ✅ Template existiert (oder wird neu erstellt)\n\n';
    doc += '- ✅ Datenquellen vorhanden (Building, Tenant, etc.)\n\n';
    doc += '- ℹ️ Textbausteine optional\n\n';
    
    doc += '### 11.3 Schritt-für-Schritt (Standard-Wizard)\n\n';
    doc += '**SCHRITT 1: Template wählen**\n\n';
    doc += '- **Seite**: `/Documents` → Button "Neues Dokument"\n\n';
    doc += '- **Dialog**: DocumentCreateWizard (Step 1/4)\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Template wählen (1/4)                             │\n';
    doc += '  │ [━━━━━━░░░░░░░░░░░░░░░░░░░░░░░] 25%              │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ Kategorie filtern:                                │\n';
    doc += '  │ [Alle] [Mietrecht] [Verwaltung] [Finanzen]        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ┌─────────────────────────────────────┐           │\n';
    doc += '  │ │ 📄 Mieterhöhung                     │ ← Klicken │\n';
    doc += '  │ │ Kategorie: Mietrecht                │           │\n';
    doc += '  │ │ Datenquellen: Building, Unit, ...   │           │\n';
    doc += '  │ └─────────────────────────────────────┘           │\n';
    doc += '  │ ┌─────────────────────────────────────┐           │\n';
    doc += '  │ │ 📄 Betriebskostenabrechnung         │           │\n';
    doc += '  │ │ Kategorie: Verwaltung               │           │\n';
    doc += '  │ └─────────────────────────────────────┘           │\n';
    doc += '  │ ┌─────────────────────────────────────┐           │\n';
    doc += '  │ │ 📄 Zahlungserinnerung               │           │\n';
    doc += '  │ │ Kategorie: Finanzen                 │           │\n';
    doc += '  │ └─────────────────────────────────────┘           │\n';
    doc += '  │ ... 12 weitere Templates ...                      │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Weiter: Daten auswählen →]          │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 2: Datenquellen verknüpfen**\n\n';
    doc += '- **UI**: Dynamische Felder basierend auf `template.required_data_sources`\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Datenquellen auswählen (2/4)                      │\n';
    doc += '  │ [━━━━━━━━━━━━░░░░░░░░░░░░░░░░] 50%               │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ Dieses Template benötigt:                         │\n';
    doc += '  │ • Building ✅                                      │\n';
    doc += '  │ • Unit ✅                                          │\n';
    doc += '  │ • Tenant ✅                                        │\n';
    doc += '  │ • Contract ✅                                      │\n';
    ...
    doc += '  │   → "Whg. 1.OG links"                             │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Auto] Aktueller Mietvertrag                      │\n';
    doc += '  │   → Automatisch geladen (unit_id + status=active)│\n';
    doc += '  │   → Max Mustermann, seit 01.02.2020               │\n';
    doc += '  │   → 800€ Kaltmiete                                │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Auto] Mieter                                     │\n';
    doc += '  │   → Max Mustermann (aus Vertrag)                  │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Auto] Empfänger-Adresse                          │\n';
    doc += '  │   Max Mustermann                                  │\n';
    doc += '  │   Whg. 1.OG links                                 │\n';
    doc += '  │   Hauptstraße 1                                   │\n';
    doc += '  │   10115 Berlin                                    │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [← Zurück]  [Weiter: Textbausteine →]             │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    doc += '- **Auto-Fill-Logik**:\n\n';
    doc += '  ```javascript\n';
    doc += '  // Nach Auswahl von Unit\n';
    doc += '  const contract = await LeaseContract.filter({\n';
    doc += '    unit_id: selectedUnit.id,\n';
    doc += '    status: "active"\n';
    doc += '  });\n';
    doc += '  setSelectedContract(contract[0]);\n';
    doc += '  \n';
    doc += '  // Nach Auswahl von Contract\n';
    doc += '  const tenant = await Tenant.get(contract.tenant_id);\n';
    doc += '  setSelectedTenant(tenant);\n';
    doc += '  \n';
    doc += '  // Empfänger-Adresse automatisch zusammenbauen\n';
    doc += '  const recipientAddress = `${tenant.first_name} ${tenant.last_name}\\n${unit.name}\\n${building.address}\\n${building.zip_code} ${building.city}`;\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 3: Textbausteine auswählen (optional)**\n\n';
    doc += '- **UI**: Checkbox-Liste verfügbarer TextBlocks für diese Kategorie\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Textbausteine hinzufügen (3/4)                    │\n';
    doc += '  │ [━━━━━━━━━━━━━━━━━━░░░░░░░░░░] 75%               │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ Verfügbare Textbausteine für "Mieterhöhung":      │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ☑ Kündigungsfristen-Hinweis                       │\n';
    doc += '  │   "Bitte beachten Sie die gesetzliche..."         │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ☐ Zahlungshinweis (SEPA-Lastschrift)              │\n';
    doc += '  │   "Die erhöhte Miete wird ab..."                  │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ☑ Widerspruchsrecht (Mieterhöhung)                │\n';
    doc += '  │   "Sie können der Erhöhung innerhalb..."          │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ☐ Kontaktdaten Hausverwaltung                     │\n';
    doc += '  │   "Bei Rückfragen erreichen Sie uns..."           │\n';
    doc += '  │                                                   │\n';
    doc += '  │ 2 Textbausteine ausgewählt                        │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [← Zurück]  [Weiter: Vorschau →]                  │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 4: Vorschau & Erstellen**\n\n';
    doc += '- **UI**: HTML-Preview des finalen Dokuments (scrollbar)\n\n';
    doc += '- **Platzhalter bereits ersetzt**: {{building.name}} → "Hauptstraße 1"\n\n';
    doc += '- **Textbausteine eingefügt**: An Positionen {{textblock:id}}\n\n';
    doc += '- **User kann**: Letzte Anpassungen vornehmen (Freitext-Editor)\n\n';
    doc += '- **User-Aktion**: Button "Dokument erstellen" (grün, unten rechts)\n\n';
    doc += '- **Prozess**:\n\n';
    doc += '  1. Document Entity CREATE (content = finales HTML)\n\n';
    doc += '  2. generatePDF aufrufen (HTML → PDF)\n\n';
    doc += '  3. Document UPDATE (pdf_url, seitenanzahl)\n\n';
    doc += '  4. data_snapshot speichern (Reproduzierbarkeit)\n\n';
    doc += '- **Dauer**: ~3-5 Sekunden\n\n';
    doc += '- **Erfolg**: Toast "✅ Dokument erstellt"\n\n';
    doc += '- **Navigation**: Redirect zu `/Documents` mit neuem Dokument markiert\n\n';
    
    doc += '### 11.6 Varianten\n\n';
    doc += '**Variante A: Einfaches Dokument** (z.B. Zahlungsbestätigung)\n\n';
    doc += '- Dauer: ~3 Minuten\n\n';
    doc += '- Nur 1 Datenquelle (Tenant)\n\n';
    doc += '- Keine Textbausteine\n\n';
    doc += '- 1 Seite PDF\n\n';
    
    doc += '**Variante B: Komplexes Dokument** (z.B. Mietvertrag)\n\n';
    doc += '- Dauer: ~15 Minuten\n\n';
    doc += '- 4+ Datenquellen\n\n';
    doc += '- 5-10 Textbausteine\n\n';
    doc += '- 8-12 Seiten PDF\n\n';
    
    doc += '**Variante C: Massen-Dokument** (z.B. NK-Abrechnungen für alle Mieter)\n\n';
    doc += '- Siehe Workflow 8 (Betriebskosten)\n\n';
    doc += '- Automatische Generierung für alle Verträge\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 12: E-Mail empfangen und automatisch verarbeiten\n\n';
    
    doc += '### 12.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: IMAP E-Mail-Synchronisation mit KI-Analyse\n\n';
    doc += '- **Hauptziel**: Eingehende E-Mails automatisch importieren und Tasks vorschlagen\n\n';
    doc += '- **User-Typ**: Verwalter (Setup) + System (Auto-Sync)\n\n';
    doc += '- **Häufigkeit**: Setup einmalig, Sync stündlich automatisch\n\n';
    doc += '- **Komplexität**: Mittel (Setup komplex, dann automatisch)\n\n';
    doc += '- **Geschätzte Dauer**: Setup 10 Min, danach automatisch\n\n';
    
    doc += '### 12.2 TEIL A: SETUP (Einmalig)\n\n';
    
    doc += '**SCHRITT 1: E-Mail-Konto hinzufügen**\n\n';
    doc += '- **Seite**: `/Kommunikation` → Tab "E-Mails" → Button "+ E-Mail-Konto"\n\n';
    doc += '- **Dialog**: IMAPAccountForm\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ E-Mail-Konto verbinden                            │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Pflicht] Kontoname                               │\n';
    doc += '  │   → "Hausverwaltung Info"                         │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] E-Mail-Adresse                          │\n';
    doc += '  │   → "info@hausverwaltung-mueller.de"              │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] IMAP-Server                             │\n';
    doc += '  │   → "imap.strato.de" (oder Gmail, GMX, etc.)      │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Port                                    │\n';
    doc += '  │   → 993 (Standard für SSL)                        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Benutzername                            │\n';
    doc += '  │   → "info@hausverwaltung-mueller.de" (meist = E-Mail)│\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Passwort                                │\n';
    doc += '  │   → "••••••••••••" (App-Passwort empfohlen)       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] ☐ SSL verwenden (empfohlen)            │\n';
    doc += '  │   → ✅ vorausgewählt                              │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ─── DSGVO & KI-Analyse ───                        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] ☐ KI-Analyse aktivieren (Opt-in!)      │\n';
    doc += '  │   ⚠️ E-Mails werden an KI-Service übermittelt     │\n';
    doc += '  │   → Automatische Task-Vorschläge                  │\n';
    doc += '  │   → Kategorisierung von Anhängen                  │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] ☐ Verarbeitete E-Mails automatisch     │\n';
    doc += '  │              löschen nach [30] Tagen              │\n';
    doc += '  │   → DSGVO-Compliance (Datensparsamkeit)           │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ ℹ️ Datenschutz-Hinweis:                           │\n';
    doc += '  │ Wenn KI-Analyse aktiviert, werden E-Mails an      │\n';
    doc += '  │ einen KI-Dienst (OpenAI) übermittelt. Anhänge     │\n';
    doc += '  │ werden NICHT übertragen.                          │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Verbindung testen] [Abbrechen] [Speichern]       │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 2: Verbindung testen**\n\n';
    doc += '- **User-Aktion**: Button "Verbindung testen" (optional, aber empfohlen)\n\n';
    doc += '- **Prozess**: Test-Login zu IMAP-Server\n\n';
    doc += '  ```javascript\n';
    doc += '  // Backend-Test (ohne Speichern)\n';
    doc += '  try {\n';
    doc += '    const imap = new ImapClient({\n';
    doc += '      host: "imap.strato.de",\n';
    doc += '      port: 993,\n';
    doc += '      secure: true,\n';
    doc += '      auth: { user: username, pass: password }\n';
    doc += '    });\n';
    doc += '    \n';
    doc += '    await imap.connect();\n';
    doc += '    await imap.selectMailbox("INBOX");\n';
    doc += '    const count = await imap.getMessageCount();\n';
    doc += '    await imap.logout();\n';
    doc += '    \n';
    doc += '    return { success: true, message_count: count };\n';
    doc += '  } catch (error) {\n';
    doc += '    return { success: false, error: error.message };\n';
    doc += '  }\n';
    doc += '  ```\n\n';
    doc += '- **Bei Erfolg**: ✅ Toast "Verbindung erfolgreich - 42 Nachrichten im Postfach"\n\n';
    doc += '- **Bei Fehler**: ❌ Toast "Verbindung fehlgeschlagen: Falsches Passwort"\n\n';
    
    doc += '**SCHRITT 3: Speichern**\n\n';
    doc += '- **Hintergrund**:\n\n';
    doc += '  ```javascript\n';
    doc += '  await IMAPAccount.create({\n';
    doc += '    name: "Hausverwaltung Info",\n';
    doc += '    email_address: "info@hausverwaltung-mueller.de",\n';
    doc += '    imap_server: "imap.strato.de",\n';
    doc += '    imap_port: 993,\n';
    doc += '    username: "info@hausverwaltung-mueller.de",\n';
    doc += '    password_encrypted: encrypt(password),  // verschlüsselt!\n';
    doc += '    use_ssl: true,\n';
    doc += '    is_active: true,\n';
    doc += '    ai_analysis_enabled: true,  // User hat Opt-in gegeben\n';
    doc += '    auto_delete_processed: true,\n';
    doc += '    delete_after_days: 30\n';
    doc += '  });\n';
    doc += '  ```\n\n';
    
    doc += '### 12.3 TEIL B: AUTOMATISCHER SYNC (Stündlich)\n\n';
    
    doc += '**Trigger**: Scheduled Task "syncEmails" - stündlich\n\n';
    doc += '**Backend-Funktion**: `functions/syncEmails.js`\n\n';
    doc += '**Prozess**:\n\n';
    doc += '```javascript\n';
    doc += '// Für jedes aktive IMAP-Konto\n';
    doc += 'const accounts = await IMAPAccount.filter({ is_active: true });\n';
    doc += '\n';
    doc += 'for (const account of accounts) {\n';
    doc += '  // 1. IMAP verbinden\n';
    doc += '  const imap = new ImapClient({ /* ... */ });\n';
    doc += '  await imap.connect();\n';
    doc += '  await imap.selectMailbox("INBOX");\n';
    doc += '  \n';
    doc += '  // 2. Nur UNGELESENE E-Mails holen\n';
    doc += '  const messages = await imap.search({ unseen: true });\n';
    doc += '  \n';
    doc += '  for (const msg of messages) {\n';
    doc += '    // 3. E-Mail abrufen\n';
    doc += '    const email = await imap.fetchOne(msg.uid, { \n';
    doc += '      body: true, \n';
    doc += '      envelope: true,\n';
    doc += '      attachments: true \n';
    doc += '    });\n';
    doc += '    \n';
    doc += '    // 4. Duplikat-Check (message_id)\n';
    doc += '    const exists = await Email.filter({ message_id: email.messageId });\n';
    doc += '    if (exists.length > 0) continue;  // skip\n';
    doc += '    \n';
    doc += '    // 5. Anhänge hochladen\n';
    doc += '    const attachments = [];\n';
    doc += '    for (const att of email.attachments) {\n';
    doc += '      const { file_url } = await base44.integrations.Core.UploadFile({\n';
    doc += '        file: att.content\n';
    doc += '      });\n';
    doc += '      attachments.push({ filename: att.filename, url: file_url });\n';
    doc += '    }\n';
    doc += '    \n';
    doc += '    // 6. Email Entity erstellen\n';
    doc += '    const emailEntity = await Email.create({\n';
    doc += '      subject: email.subject,\n';
    doc += '      sender_email: email.from.address,\n';
    doc += '      sender_name: email.from.name,\n';
    doc += '      received_date: email.date,\n';
    doc += '      body_text: email.text,\n';
    doc += '      body_html: email.html,\n';
    doc += '      attachments: attachments,\n';
    doc += '      imap_account_id: account.id,\n';
    doc += '      message_id: email.messageId\n';
    doc += '    });\n';
    doc += '    \n';
    doc += '    // 7. KI-Analyse (falls aktiviert)\n';
    doc += '    if (account.ai_analysis_enabled) {\n';
    doc += '      const suggestion = await base44.integrations.Core.InvokeLLM({\n';
    doc += '        prompt: `Analysiere diese E-Mail und schlage einen Task vor:\n';
    doc += '        \n';
    doc += '        Von: ${email.sender_name} <${email.sender_email}>\n';
    doc += '        Betreff: ${email.subject}\n';
    doc += '        Text: ${email.text}\n';
    ...
    doc += '          "priority": "niedrig"|"normal"|"hoch",\n';
    doc += '          "due_date": "YYYY-MM-DD" oder null,\n';
    doc += '          "assigned_building": "Straße erkannt?" oder null\n';
    doc += '        }`,\n';
    doc += '        response_json_schema: { /* ... */ }\n';
    doc += '      });\n';
    doc += '      \n';
    doc += '      // Suggestion speichern\n';
    doc += '      await emailEntity.update({\n';
    doc += '        ai_suggested_task: suggestion,\n';
    doc += '        has_task: false  // User muss noch bestätigen\n';
    doc += '      });\n';
    doc += '      \n';
    doc += '      // Notification für User\n';
    doc += '      if (suggestion.should_create_task) {\n';
    doc += '        await Notification.create({\n';
    doc += '          type: "info",\n';
    doc += '          title: "Neue E-Mail mit Task-Vorschlag",\n';
    doc += '          message: `Von: ${email.sender_name} - "${suggestion.task_title}"`,\n';
    doc += '          action_url: `/Kommunikation?tab=emails&emailId=${emailEntity.id}`\n';
    doc += '        });\n';
    doc += '      }\n';
    doc += '    }\n';
    doc += '    \n';
    doc += '    // 8. Als gelesen markieren (IMAP)\n';
    doc += '    await imap.addFlags(msg.uid, ["\\\\Seen"]);\n';
    doc += '    \n';
    doc += '    // 9. Optional: Von Server löschen (wenn auto_delete_processed)\n';
    doc += '    // await imap.deleteMessage(msg.uid);\n';
    doc += '  }\n';
    doc += '  \n';
    doc += '  await imap.logout();\n';
    doc += '  \n';
    doc += '  // 10. Last-Sync-Timestamp aktualisieren\n';
    doc += '  await account.update({ last_sync: new Date() });\n';
    doc += '}\n';
    doc += '```\n\n';
    
    doc += '### 12.4 TEIL C: USER REAGIERT AUF E-MAIL\n\n';
    doc += '**User öffnet E-Mail-Liste**:\n\n';
    doc += '- **Seite**: `/Kommunikation` → Tab "E-Mails"\n\n';
    doc += '- **UI**: Tabelle aller Emails\n\n';
    doc += '  ```\n';
    doc += '  ┌─────────────────────────────────────────────────────────────┐\n';
    doc += '  │ Datum       │ Von                 │ Betreff         │ Task │\n';
    doc += '  ├─────────────┼─────────────────────┼─────────────────┼──────┤\n';
    doc += '  │ 07.01. 14:32│ Max Mustermann      │ Heizung defekt  │ 💡✨ │\n';
    doc += '  │ 07.01. 10:15│ Rechnung@strom.de   │ Rechnung Januar │ 💡   │\n';
    doc += '  │ 06.01. 18:20│ Anna Schmidt        │ Kündigung       │ 💡✨ │\n';
    doc += '  └─────────────────────────────────────────────────────────────┘\n';
    doc += '  \n';
    doc += '  Legende:\n';
    doc += '  💡 = KI hat Task vorgeschlagen\n';
    doc += '  ✨ = Hohe Priorität\n';
    doc += '  ```\n\n';
    
    doc += '**User klickt auf E-Mail mit Task-Vorschlag**:\n\n';
    doc += '- **Detail-Ansicht** öffnet sich:\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ ✉️ Heizung defekt                                 │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ Von: Max Mustermann <max@example.com>             │\n';
    doc += '  │ Datum: 07.01.2024 14:32 Uhr                       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ Sehr geehrte Damen und Herren,                    │\n';
    doc += '  │                                                   │\n';
    doc += '  │ die Heizung in meiner Wohnung (1.OG links) ist    │\n';
    doc += '  │ seit heute Morgen defekt. Es kommt kein warmes    │\n';
    doc += '  │ Wasser mehr. Bitte um schnelle Reparatur.         │\n';
    doc += '  │                                                   │\n';
    doc += '  │ Mit freundlichen Grüßen                           │\n';
    doc += '  │ Max Mustermann                                    │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ 💡 KI-TASK-VORSCHLAG:                             │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ ✅ Task erstellen empfohlen                       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ Titel: "Heizung reparieren - Whg. 1.OG links"     │\n';
    doc += '  │ Beschreibung: "Mieter Max Mustermann meldet..."   │\n';
    doc += '  │ Priorität: HOCH (Heizungsausfall)                 │\n';
    doc += '  │ Fällig: 09.01.2024 (in 2 Tagen)                   │\n';
    doc += '  │ Objekt: Hauptstraße 1 (erkannt aus Signatur)      │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Task erstellen] [Ignorieren] [Anpassen]          │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**User-Aktion**: Button "Task erstellen"\n\n';
    doc += '- **Prozess**:\n\n';
    doc += '  ```javascript\n';
    doc += '  const task = await Task.create({\n';
    doc += '    title: suggestion.task_title,\n';
    doc += '    description: suggestion.task_description,\n';
    doc += '    status: "offen",\n';
    doc += '    priority_id: getPriorityId(suggestion.priority),  // "hoch"\n';
    doc += '    due_date: suggestion.due_date,\n';
    doc += '    assigned_object_id: suggestion.assigned_building,\n';
    doc += '    email_id: emailEntity.id,  // Verknüpfung zu Email\n';
    doc += '    is_automated: true\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  await emailEntity.update({\n';
    doc += '    has_task: true,\n';
    ...
    doc += '  });\n';
    doc += '  ```\n\n';
    doc += '- **Erfolg**: Toast "✅ Task erstellt"\n\n';
    doc += '- **Navigation**: Redirect zu `/Tasks` mit neuem Task markiert\n\n';
    
    doc += '### 12.5 Tipps & Best Practices\n\n';
    doc += '✅ **DO**: App-Passwort verwenden (nicht Haupt-Passwort)\n\n';
    doc += '✅ **DO**: KI-Analyse aktivieren (spart viel Zeit)\n\n';
    doc += '✅ **DO**: Auto-Delete aktivieren (DSGVO-Compliance)\n\n';
    doc += '✅ **DO**: Separates E-Mail-Konto nur für Verwaltung (nicht privat mischen)\n\n';
    doc += '❌ **DON\'T**: Haupt-Passwort verwenden (Sicherheitsrisiko)\n\n';
    doc += '❌ **DON\'T**: E-Mails ewig aufbewahren (DSGVO-Problem)\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 13: Aufgabe erstellen und Workflow triggern\n\n';
    
    doc += '### 13.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Manuelle Task-Erstellung\n\n';
    doc += '- **Hauptziel**: Aufgabe im System erfassen mit optionalem Workflow\n\n';
    doc += '- **User-Typ**: Verwalter\n\n';
    doc += '- **Häufigkeit**: Täglich (mehrfach)\n\n';
    doc += '- **Komplexität**: Einfach (~2 Minuten)\n\n';
    doc += '- **Geschätzte Dauer**: 2-3 Minuten\n\n';
    
    doc += '### 13.2 Schritt-für-Schritt\n\n';
    doc += '**SCHRITT 1: Task-Formular öffnen**\n\n';
    doc += '- **Seite**: `/Tasks` → Button "+ Neue Aufgabe"\n\n';
    doc += '- **Dialog**: TaskForm\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Neue Aufgabe erstellen                            │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Pflicht] Titel                                   │\n';
    doc += '  │   → "Mieterhöhung vorbereiten - Whg. 2"           │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Beschreibung                           │\n';
    doc += '  │   → "Mietspiegel prüfen, neue Miete berechnen,    │\n';
    doc += '  │      Dokument vorbereiten"                        │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Status ▼                                │\n';
    doc += '  │   → "Offen" (Standard)                            │\n';
    doc += '  │   Optionen: Offen, In Bearbeitung, Wartend,       │\n';
    doc += '  │             Erledigt, Abgebrochen                 │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Priorität ▼                            │\n';
    doc += '  │   → "Normal"                                      │\n';
    doc += '  │   Optionen: Niedrig, Normal, Hoch, Kritisch       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Fälligkeitsdatum 📅                    │\n';
    doc += '  │   → "31.01.2024"                                  │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Zugeordnetes Objekt ▼                  │\n';
    doc += '  │   → "Hauptstraße 1, Berlin"                       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Zugeordneter Mieter ▼                  │\n';
    doc += '  │   → (leer bei objektbezogenen Tasks)              │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Verknüpftes Dokument ▼                 │\n';
    doc += '  │   → (falls Task aus Dokument entsteht)            │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ─── WORKFLOW (Optional) ───                       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] ☐ Workflow zuordnen                    │\n';
    doc += '  │   Workflow ▼                                      │\n';
    doc += '  │   → "Mieterhöhung-Prozess" (vordefiniert)         │\n';
    doc += '  │                                                   │\n';
    doc += '  │   → Bei Auswahl: Automatische Folge-Tasks werden  │\n';
    doc += '  │      erstellt (z.B. "Dokument erstellen" nach     │\n';
    doc += '  │      3 Tagen, "Versand" nach 5 Tagen)             │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Task erstellen]                     │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 2: Speichern**\n\n';
    doc += '- **Hintergrund**:\n\n';
    doc += '  ```javascript\n';
    doc += '  const task = await Task.create({\n';
    doc += '    title: "Mieterhöhung vorbereiten - Whg. 2",\n';
    doc += '    description: "Mietspiegel prüfen...",\n';
    doc += '    status: "offen",\n';
    doc += '    priority_id: normalPriorityId,\n';
    doc += '    due_date: "2024-01-31",\n';
    doc += '    assigned_object_id: building.id,\n';
    doc += '    workflow_id: selectedWorkflow?.id || null\n';
    doc += '  });\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 3: Workflow triggern (falls aktiviert)**\n\n';
    doc += '- **Trigger**: `workflow_id` gesetzt\n\n';
    doc += '- **Prozess**: Automatische Folge-Tasks erstellen\n\n';
    doc += '  ```javascript\n';
    doc += '  if (task.workflow_id) {\n';
    doc += '    const workflow = await Workflow.get(task.workflow_id);\n';
    doc += '    const steps = await WorkflowStep.filter({ \n';
    doc += '      workflow_id: workflow.id \n';
    doc += '    }).sort("step_order");\n';
    doc += '    \n';
    doc += '    // Nächste Schritte erstellen\n';
    doc += '    for (const step of steps.slice(1)) {  // Step 0 = aktueller Task\n';
    doc += '      const dueDate = addDays(task.due_date, step.next_step_delay_days);\n';
    doc += '      \n';
    doc += '      await Task.create({\n';
    doc += '        title: step.step_name,\n';
    doc += '        description: step.action_config.description,\n';
    doc += '        status: "offen",\n';
    doc += '        due_date: dueDate,\n';
    doc += '        parent_task_id: task.id,  // Verknüpfung\n';
    doc += '        workflow_id: workflow.id,\n';
    doc += '        is_automated: step.is_automated\n';
    doc += '      });\n';
    doc += '    }\n';
    doc += '  }\n';
    doc += '  ```\n\n';
    
    doc += '### 13.3 Ausgabe/Ergebnis\n\n';
    doc += '**Ohne Workflow**:\n\n';
    doc += '- 1x Task\n\n';
    
    doc += '**Mit Workflow** (z.B. "Mieterhöhung-Prozess"):\n\n';
    doc += '- 1x Task (Haupt-Task)\n\n';
    doc += '- 4x Task (Folge-Tasks):\n\n';
    doc += '  - "Mietspiegel prüfen" (fällig in 3 Tagen)\n\n';
    doc += '  - "Mieterhöhungs-Dokument erstellen" (fällig in 7 Tagen)\n\n';
    doc += '  - "Dokument per Einschreiben versenden" (fällig in 10 Tagen)\n\n';
    doc += '  - "Mieterreaktion abwarten" (fällig in 70 Tagen = 2 Monate Frist)\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 16: Massenänderung durchführen\n\n';
    
    doc += '### 16.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Bulk-Update (Massenbearbeitung)\n\n';
    doc += '- **Hauptziel**: Mehrere Datensätze gleichzeitig ändern\n\n';
    doc += '- **User-Typ**: Admin, Verwalter\n\n';
    doc += '- **Häufigkeit**: Gelegentlich (bei System-weiten Änderungen)\n\n';
    doc += '- **Komplexität**: Mittel (potenziell destruktiv)\n\n';
    doc += '- **Geschätzte Dauer**: 3-5 Minuten\n\n';
    
    doc += '### 16.2 Anwendungsfälle\n\n';
    doc += '1. **Alle Rechnungen eines Lieferanten kategorisieren**\n\n';
    doc += '   - Beispiel: 20 Strom-Rechnungen von "Stadtwerke" → Kategorie "Strom"\n\n';
    doc += '2. **Alle Buchungen eines Jahres auf "Gebucht" setzen**\n\n';
    doc += '   - Nach Jahresabschluss: Alle 2023er Buchungen → status="Gebucht"\n\n';
    doc += '3. **Verteilerschlüssel für Betriebskosten ändern**\n\n';
    doc += '   - Beispiel: Müllabfuhr von "Fläche" auf "Personen" umstellen\n\n';
    doc += '4. **Zahlungsrhythmus von Versorgern ändern**\n\n';
    doc += '   - Beispiel: Strom von "Monatlich" auf "Vierteljährlich"\n\n';
    
    doc += '### 16.3 Schritt-für-Schritt (Beispiel: Rechnungen kategorisieren)\n\n';
    doc += '**SCHRITT 1: Rechnungen filtern**\n\n';
    doc += '- **Seite**: `/Invoices`\n\n';
    doc += '- **Filter setzen**:\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ FILTER:                                           │\n';
    doc += '  │ Lieferant: [Stadtwerke          ] 🔍             │\n';
    doc += '  │ Kategorie: [Nicht kategorisiert ▼]               │\n';
    doc += '  │ Zeitraum:  [2024              ▼]                 │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ ℹ️ 20 Rechnungen gefunden                         │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 2: Auswählen**\n\n';
    doc += '- **UI**: Checkboxen in Tabelle\n\n';
    doc += '  ```\n';
    doc += '  ┌─────────────────────────────────────────────────────────┐\n';
    doc += '  │ ☑ │ Datum      │ Rechnung    │ Betrag   │ Kategorie │\n';
    doc += '  ├───┼────────────┼─────────────┼──────────┼───────────┤\n';
    doc += '  │ ☑ │ 05.01.2024 │ RE-2024-001 │ 80,00 €  │ -         │\n';
    doc += '  │ ☑ │ 05.02.2024 │ RE-2024-002 │ 80,00 €  │ -         │\n';
    doc += '  │ ☑ │ 05.03.2024 │ RE-2024-003 │ 80,00 €  │ -         │\n';
    doc += '  │ ...│           │             │          │           │\n';
    doc += '  │ ☑ │ 05.12.2024 │ RE-2024-012 │ 80,00 €  │ -         │\n';
    doc += '  ├───┴────────────┴─────────────┴──────────┴───────────┤\n';
    doc += '  │ ✅ 20 Rechnungen ausgewählt                         │\n';
    doc += '  └─────────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    doc += '- **Alternativen**:\n\n';
    doc += '  - "Alle auswählen" Checkbox (Header-Zeile)\n\n';
    doc += '  - "Seite auswählen" (nur sichtbare 50 Einträge)\n\n';
    doc += '  - Manuell einzeln auswählen\n\n';
    
    doc += '**SCHRITT 3: Massen-Aktion wählen**\n\n';
    doc += '- **UI**: Aktionsleiste erscheint (wenn > 0 ausgewählt)\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ 20 Rechnungen ausgewählt                          │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ Aktion: [Kategorie zuweisen ▼]                    │\n';
    doc += '  │                                                   │\n';
    doc += '  │ Andere Aktionen:                                  │\n';
    doc += '  │ • Status ändern                                   │\n';
    doc += '  │ • Gebäude zuordnen                                │\n';
    doc += '  │ • Als bezahlt markieren                           │\n';
    doc += '  │ • Löschen (⚠️ irreversibel)                       │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Ausführen]                                       │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 4: Parameter eingeben**\n\n';
    doc += '- **User-Aktion**: "Kategorie zuweisen" auswählen\n\n';
    doc += '- **Sub-Dialog**:\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Kategorie für 20 Rechnungen setzen                │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Pflicht] Neue Kategorie ▼                        │\n';
    doc += '  │   → "Strom/Gas/Wasser"                            │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ⚠️ Dies ändert 20 Rechnungen gleichzeitig!        │\n';
    doc += '  │    Bitte prüfen Sie die Auswahl.                  │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Jetzt ausführen]                    │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 5: Ausführen**\n\n';
    doc += '- **User-Aktion**: Button "Jetzt ausführen"\n\n';
    doc += '- **Bestätigungs-Dialog** (Sicherheitsabfrage):\n\n';
    doc += '  ```\n';
    doc += '  ⚠️ BESTÄTIGUNG ERFORDERLICH\n';
    doc += '  \n';
    doc += '  20 Rechnungen werden geändert:\n';
    doc += '  • Kategorie → "Strom/Gas/Wasser"\n';
    doc += '  \n';
    doc += '  Diese Aktion kann nicht rückgängig gemacht werden!\n';
    doc += '  \n';
    doc += '  [Nein, abbrechen]  [Ja, ausführen]\n';
    doc += '  ```\n\n';
    doc += '- **Hintergrund** (Backend-Funktion: `bulkUpdateInvoices`):\n\n';
    doc += '  ```javascript\n';
    doc += '  const { invoice_ids, updates } = await req.json();\n';
    doc += '  \n';
    doc += '  let successCount = 0;\n';
    doc += '  let errorCount = 0;\n';
    doc += '  \n';
    doc += '  for (const id of invoice_ids) {\n';
    doc += '    try {\n';
    doc += '      await base44.entities.Invoice.update(id, updates);\n';
    doc += '      successCount++;\n';
    doc += '    } catch (error) {\n';
    doc += '      errorCount++;\n';
    doc += '      console.error(`Failed to update invoice ${id}:`, error);\n';
    doc += '    }\n';
    doc += '  }\n';
    doc += '  \n';
    doc += '  // ActivityLog\n';
    doc += '  await ActivityLog.create({\n';
    doc += '    action: "bulk_update_invoices",\n';
    doc += '    details: {\n';
    doc += '      count: successCount,\n';
    doc += '      errors: errorCount,\n';
    doc += '      field: "cost_category_id",\n';
    doc += '      new_value: updates.cost_category_id\n';
    doc += '    }\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  return { success: true, updated: successCount, errors: errorCount };\n';
    doc += '  ```\n\n';
    doc += '- **Dauer**: ~2-5 Sekunden (abhängig von Anzahl)\n\n';
    doc += '- **Erfolg**: Toast "✅ 20 Rechnungen aktualisiert"\n\n';
    doc += '- **Bei Fehlern**: Toast "⚠️ 18 erfolgreich, 2 Fehler (Details im Log)"\n\n';
    
    doc += '### 16.4 Fehlerszenarien\n\n';
    doc += '**Fehler 1: Constraint-Violation**\n\n';
    doc += '- **Szenario**: Bulk-Update setzt ungültigen Wert (z.B. cost_category_id existiert nicht)\n\n';
    doc += '- **Reaktion**: Rollback für ALLE Updates (Transaktion schlägt fehl)\n\n';
    doc += '- **User-Meldung**: "❌ Bulk-Update fehlgeschlagen: Ungültige Kategorie-ID"\n\n';
    
    doc += '### 16.5 Tipps & Best Practices\n\n';
    doc += '✅ **DO**: Vor Bulk-Update Filter testen (nur 1-2 Einträge auswählen zum Test)\n\n';
    doc += '✅ **DO**: Sicherheits-Bestätigung immer lesen (nicht blind klicken)\n\n';
    doc += '❌ **DON\'T**: Bulk-Delete ohne vorherigen Backup (irreversibel!)\n\n';
    doc += '❌ **DON\'T**: Zu breite Filter (z.B. "Alle Rechnungen" ohne Jahres-Filter)\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 17: Daten exportieren\n\n';
    
    doc += '### 17.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Daten-Export (CSV, Excel, PDF)\n\n';
    doc += '- **Hauptziel**: Daten aus App exportieren für externe Nutzung\n\n';
    doc += '- **User-Typ**: Verwalter, Steuerberater\n\n';
    doc += '- **Häufigkeit**: Monatlich / bei Bedarf\n\n';
    doc += '- **Komplexität**: Einfach (~2 Minuten)\n\n';
    doc += '- **Geschätzte Dauer**: 2 Minuten\n\n';
    
    doc += '### 17.2 Varianten\n\n';
    doc += '**A) Anlage V PDF exportieren**\n\n';
    doc += '- **Seite**: `/TaxForms` → Anlage V öffnen → Button "PDF exportieren"\n\n';
    doc += '- **Ergebnis**: Offizielles Finanzamt-Layout als PDF\n\n';
    doc += '- **Verwendung**: Steuererklärung, Steuerberater\n\n';
    
    doc += '**B) Betriebskosten als Excel**\n\n';
    doc += '- **Seite**: `/OperatingCosts` → Abrechnung öffnen → "Excel exportieren"\n\n';
    doc += '- **Ergebnis**: .xlsx mit Tabellen (Kosten, Verteilung, pro Mieter)\n\n';
    doc += '- **Verwendung**: Externe Auswertung, Archivierung\n\n';
    
    doc += '**C) Transaktionen als CSV**\n\n';
    doc += '- **Seite**: `/BankAccounts` → Konto öffnen → "Transaktionen exportieren"\n\n';
    doc += '- **Filter**: Zeitraum wählen (z.B. "2024", "Q1 2024", "Januar 2024")\n\n';
    doc += '- **Format**: CSV (für Import in Excel, DATEV, etc.)\n\n';
    doc += '- **Spalten**: Datum, Betrag, Zweck, Empfänger, IBAN, Kategorie, Matching-Status\n\n';
    
    doc += '**D) Alle Daten als JSON (Entwickler)**\n\n';
    doc += '- **Nur Admin**: `/DeveloperDocumentation` → "Alle Daten exportieren"\n\n';
    doc += '- **Umfang**: ALLE Entities als JSON-Dump\n\n';
    doc += '- **Größe**: Mehrere MB (bei großen Datenbeständen)\n\n';
    doc += '- **Verwendung**: Migration, Backup, Entwicklung\n\n';
    
    doc += '### 17.3 Beispiel: Transaktionen exportieren\n\n';
    doc += '**SCHRITT 1: Export-Dialog öffnen**\n\n';
    doc += '- **Button**: "Exportieren" (Download-Icon)\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Transaktionen exportieren                         │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Pflicht] Format ▼                                │\n';
    ...
    doc += '  │   ⚪ PDF (Druckbar)                               │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Pflicht] Zeitraum ▼                              │\n';
    doc += '  │   → "2024"                                        │\n';
    doc += '  │   Optionen: 2024, 2023, Q1 2024, Benutzerdefiniert│\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Filter ▼                               │\n';
    doc += '  │   ☐ Nur kategorisierte                            │\n';
    doc += '  │   ☐ Nur unkategorisierte                          │\n';
    doc += '  │   ☐ Nur Einnahmen (> 0)                           │\n';
    doc += '  │   ☐ Nur Ausgaben (< 0)                            │\n';
    doc += '  │                                                   │\n';
    doc += '  │ ℹ️ 156 Transaktionen im Zeitraum                  │\n';
    doc += '  │ ℹ️ Geschätzte Dateigröße: ~25 KB                  │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Jetzt exportieren]                  │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 2: Export durchführen**\n\n';
    doc += '- **Hintergrund** (Frontend):\n\n';
    doc += '  ```javascript\n';
    doc += '  // Transaktionen laden\n';
    doc += '  const transactions = await base44.entities.BankTransaction.filter({\n';
    doc += '    bank_account_id: accountId,\n';
    doc += '    booking_date: { $gte: "2024-01-01", $lte: "2024-12-31" }\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  // CSV generieren\n';
    doc += '  let csv = "Datum;Betrag;Zweck;Empfänger;IBAN;Kategorie;Matched\\n";\n';
    doc += '  \n';
    doc += '  for (const tx of transactions) {\n';
    doc += '    const category = tx.cost_category_id \n';
    doc += '      ? await getCostCategory(tx.cost_category_id)\n';
    doc += '      : null;\n';
    doc += '    \n';
    doc += '    csv += `${tx.booking_date};`;\n';
    doc += '    csv += `${tx.amount.toFixed(2)};`;\n';
    doc += '    csv += `"${tx.purpose || ""}";`;\n';
    doc += '    csv += `"${tx.counterpart_name || ""}";`;\n';
    doc += '    csv += `${tx.counterpart_iban || ""};`;\n';
    doc += '    csv += `"${category?.name || "-"}";`;\n';
    doc += '    csv += `${tx.matched ? "Ja" : "Nein"}\\n`;\n';
    doc += '  }\n';
    doc += '  \n';
    doc += '  // Download triggern\n';
    doc += '  const blob = new Blob([csv], { type: "text/csv;charset=utf-8;" });\n';
    doc += '  const url = window.URL.createObjectURL(blob);\n';
    doc += '  const a = document.createElement("a");\n';
    doc += '  a.href = url;\n';
    doc += '  a.download = `Transaktionen_2024_${Date.now()}.csv`;\n';
    doc += '  document.body.appendChild(a);\n';
    doc += '  a.click();\n';
    doc += '  window.URL.revokeObjectURL(url);\n';
    doc += '  a.remove();\n';
    doc += '  ```\n\n';
    doc += '- **Dauer**: ~2 Sekunden (bei 156 Transaktionen)\n\n';
    doc += '- **Erfolg**: Datei-Download startet automatisch\n\n';
    
    doc += '---\n\n';
    
    doc += '## WORKFLOW 18: Reporting / Auswertung erstellen\n\n';
    
    doc += '### 18.1 Identifikation\n\n';
    doc += '- **Workflow-Name**: Finanzielle Auswertungen & Reports\n\n';
    doc += '- **Hauptziel**: Übersichten und Statistiken generieren\n\n';
    doc += '- **User-Typ**: Verwalter, Eigentümer\n\n';
    doc += '- **Häufigkeit**: Monatlich (Monatsabschluss), jährlich (Jahresbericht)\n\n';
    doc += '- **Komplexität**: Mittel (~10 Minuten)\n\n';
    doc += '- **Geschätzte Dauer**: 10 Minuten\n\n';
    
    doc += '### 18.2 Anwendungsfälle\n\n';
    doc += '1. **Dashboard (Echtzeit-Übersicht)**\n\n';
    doc += '   - **Seite**: `/Dashboard`\n\n';
    doc += '   - **Angezeigt**: \n\n';
    doc += '     - Anzahl Objekte, Wohnungen, Mieter\n\n';
    doc += '     - Mieteinnahmen aktueller Monat\n\n';
    doc += '     - Offene Rechnungen / Zahlungen\n\n';
    doc += '     - Überfällige Posten (rot markiert)\n\n';
    doc += '     - Aktuelle Tasks (Top 5)\n\n';
    doc += '     - Letzte Aktivitäten\n\n';
    
    doc += '2. **Finanz-Report (Monatlich)**\n\n';
    doc += '   - **Seite**: `/Finanzen` → Tab "Reports"\n\n';
    doc += '   - **Filter**: Monat/Jahr wählen\n\n';
    doc += '   - **Angezeigt**:\n\n';
    doc += '     - Einnahmen (Mieten)\n\n';
    doc += '     - Ausgaben (nach Kategorien)\n\n';
    doc += '     - Saldo (Einnahmen - Ausgaben)\n\n';
    doc += '     - Chart: Entwicklung über 12 Monate\n\n';
    doc += '     - Top 5 Kostenarten\n\n';
    
    doc += '3. **Eigentümer-Report (Quartalsweise)**\n\n';
    doc += '   - **Zweck**: Übersicht für Eigentümer generieren\n\n';
    doc += '   - **Inhalt**:\n\n';
    doc += '     - Mieteinnahmen (Ist vs. Soll)\n\n';
    doc += '     - Kosten (gruppiert nach Kategorien)\n\n';
    doc += '     - Leerstand (Tage/Prozent)\n\n';
    doc += '     - Offene Posten\n\n';
    doc += '     - Netto-Überschuss\n\n';
    
    doc += '4. **Steuer-Export (Jährlich)**\n\n';
    doc += '   - **Seite**: `/TaxForms`\n\n';
    doc += '   - **Export**: Anlage V als PDF\n\n';
    doc += '   - **Alternative**: EÜR-Export (Einnahmen-Überschuss-Rechnung)\n\n';
    
    doc += '### 18.3 Beispiel: Monats-Report generieren\n\n';
    doc += '**SCHRITT 1: Report-Dialog öffnen**\n\n';
    doc += '- **Seite**: `/Finanzen` → Button "Report erstellen"\n\n';
    doc += '  ```\n';
    doc += '  ┌───────────────────────────────────────────────────┐\n';
    doc += '  │ Finanz-Report erstellen                           │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Pflicht] Zeitraum ▼                              │\n';
    doc += '  │   → "Dezember 2024"                               │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Objekte filtern ▼                      │\n';
    doc += '  │   → [Alle Objekte] oder spezifisches Building     │\n';
    doc += '  │                                                   │\n';
    doc += '  │ [Optional] Format ▼                               │\n';
    doc += '  │   ⚪ PDF (zum Ausdrucken)                         │\n';
    doc += '  │   ⚪ Excel (zum Weiterbearbeiten)                 │\n';
    doc += '  ├───────────────────────────────────────────────────┤\n';
    doc += '  │ [Abbrechen]  [Report generieren]                  │\n';
    doc += '  └───────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 2: Generierung**\n\n';
    doc += '- **Backend-Berechnung**:\n\n';
    doc += '  ```javascript\n';
    doc += '  // Einnahmen\n';
    doc += '  const einnahmen = await GeneratedFinancialBooking.filter({\n';
    doc += '    due_date: { $gte: "2024-12-01", $lte: "2024-12-31" },\n';
    doc += '    amount: { $gt: 0 },  // positiv = Einnahme\n';
    doc += '    booking_status: "Bezahlt"\n';
    doc += '  });\n';
    doc += '  const einnahmen_summe = sum(einnahmen.amount);\n';
    doc += '  // Beispiel: 6.180€ (6 Mieter × 1.030€)\n';
    doc += '  \n';
    doc += '  // Ausgaben\n';
    doc += '  const ausgaben = await GeneratedFinancialBooking.filter({\n';
    doc += '    due_date: { $gte: "2024-12-01", $lte: "2024-12-31" },\n';
    doc += '    amount: { $lt: 0 },  // negativ = Ausgabe\n';
    doc += '    booking_status: { $in: ["Gebucht", "Bezahlt"] }\n';
    doc += '  });\n';
    doc += '  \n';
    doc += '  // Nach Kategorien gruppieren\n';
    doc += '  const byCategory = {};\n';
    doc += '  for (const buchung of ausgaben) {\n';
    doc += '    const cat = await getCostCategory(buchung.cost_category_id);\n';
    doc += '    byCategory[cat.name] = (byCategory[cat.name] || 0) + Math.abs(buchung.amount);\n';
    doc += '  }\n';
    doc += '  \n';
    doc += '  // Ausgaben Summe\n';
    doc += '  const ausgaben_summe = sum(ausgaben.amount);\n';
    doc += '  // Beispiel: -1.850€ (Grundsteuer 300€ + Versicherung 70€ + ...)\n';
    doc += '  \n';
    doc += '  // Saldo\n';
    doc += '  const saldo = einnahmen_summe + ausgaben_summe;  // ausgaben sind negativ!\n';
    doc += '  // = 6.180€ + (-1.850€) = 4.330€ (positiv)\n';
    doc += '  ```\n\n';
    
    doc += '**SCHRITT 3: PDF generieren**\n\n';
    doc += '- **Template**: Report-Template mit Charts (Recharts)\n\n';
    doc += '- **Ergebnis-PDF** (2-3 Seiten):\n\n';
    doc += '  ```\n';
    doc += '  ┌─────────────────────────────────────────────────┐\n';
    doc += '  │ FINANZ-REPORT - DEZEMBER 2024                   │\n';
    doc += '  ├─────────────────────────────────────────────────┤\n';
    doc += '  │                                                 │\n';
    doc += '  │ EINNAHMEN:                         6.180,00 €   │\n';
    doc += '  │ • Mieteinnahmen (6 Wohnungen)      6.180,00 €   │\n';
    doc += '  │                                                 │\n';
    doc += '  │ AUSGABEN:                          1.850,00 €   │\n';
    doc += '  │ • Grundsteuer                        300,00 €   │\n';
    doc += '  │ • Versicherung                        70,83 €   │\n';
    doc += '  │ • Kredit (Zinsen)                  1.000,00 €   │\n';
    doc += '  │ • Verwaltung                          40,00 €   │\n';
    doc += '  │ • Sonstige                           439,17 €   │\n';
    doc += '  │                                                 │\n';
    doc += '  │ ═════════════════════════════════════════════   │\n';
    doc += '  │ SALDO:                             4.330,00 €   │\n';
    doc += '  │                                                 │\n';
    doc += '  │ [Bar Chart: Einnahmen vs. Ausgaben letzte 12M] │\n';
    doc += '  │ [Pie Chart: Ausgaben nach Kategorien]          │\n';
    doc += '  └─────────────────────────────────────────────────┘\n';
    doc += '  ```\n\n';
    
    doc += '### 18.4 Ausgabe/Ergebnis\n\n';
    doc += '**Dateien**:\n\n';
    doc += '- 1x CSV/Excel/PDF (Download)\n\n';
    
    doc += '**Keine DB-Änderungen** (read-only Workflow)\n\n';
